...
const ReceivedPayment = ()=>{
    return(
        <div>
          ...
          <table className="table table-sm table-hover table-responsive-md table-striped" id="table_received">
              <thead>
                <tr>
          ...
          <div className="row col-md-12">
            <div className="col-md-4  p-2">
              ...
              <ReactHTMLTableToExcel table="table_received" filename={`${date}`} sheet="sheet" buttonText="Export" className="btn btn-outline-primary" />
            </div>
